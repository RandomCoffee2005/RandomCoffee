...
- GET /myprofile(jwt:str) -> 200 {"user":{...}} / 401 {"detail":"Unauthorized"}
- PATCH /myprofile(jwt:str, full_name?:str, contact_info?:str, is_active?:bool) -> 200 {} / 401 / 404
- GET /profile/{user_id} -> 200 {"user":{...}} / 404 {"detail":"User not found"}
